...
<p><em>In this section you will find everything you need to build our entire environment to do a deeper test on VSF + ODOO and make sure our integration is what you need for your business</em></p>
<h1 id="before-you-start" tabindex="-1"><a class="header-anchor" href="#before-you-start" aria-hidden="true">#</a> Before you start</h1>
<p>Pre-requisites: Docker, Node.js (&gt;=14.19.0), npm or similar and Git.<br>
<br><br>
Last odoo <strong>version</strong> released: Clone the repo from (<a href="https://github.com/odoogap/vuestorefront-docker" target="_blank" rel="noopener noreferrer">https://github.com/odoogap/vuestorefront-docker<ExternalLinkIcon/></a>)</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>If you use Docker Desktop and some .sh files are executed during instalation, we recommend you to read Docker Desktop Documentation (<a href="https://docs.docker.com/docker-for-windows/wsl/" target="_blank" rel="noopener noreferrer">https://docs.docker.com/docker-for-windows/wsl/<ExternalLinkIcon/></a>).</p>
...
<p>Running this command will stop but will clear the Odoo database</p>
...
<p>Running this command will stop but will not clear the Odoo database</p>
